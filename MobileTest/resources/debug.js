...
//function createCirclePoints(radius, origin) {
//    for (var angle = 0; angle < 360; angle++) {
//        var x = origin.x + radius * Math.cos(angle * Math.PI / 180);
//        var y = origin.y + radius * Math.sin(angle * Math.PI / 180);
//        x = Math.floor(x);
//        y = Math.floor(y);
//        var z = 0;
//        TILES.array[TILES.array.length] = {"char":"&","color":"rgb(232,236,251)","x":z-x,"y":y,"z":x}
//    }
//}
//
//
//var origin = {x: 0, y: 0};
//var radius = 64;
//createCirclePoints(radius, origin);