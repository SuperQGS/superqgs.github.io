...
var RENDER = {    
    ...
    screenPos: function (x,y,z) {
        ...
        var distanceFromCenter = RENDER.distance({x:0,y:0},{x:x,y:y});
        ...
        screenY += 0.005 * Math.pow(distanceFromCenter, RENDER.curve);        
        
        return {x:screenX,y:screenY,s:distanceFromCenter};
    ...
    box: function (x,y,z,length,width,height) { //should this use screenpos?
    ...
    selected: function() {
        ...
        var newXY = RENDER.screenPos(YOU.x,YOU.y,YOU.z);
        context.fillText( //draw
            "&", //character
            newXY.x, //x canvas coordinate !!!should describe fields better
            newXY.y //y canvas coordinate
        ...
        context.strokeStyle = "black";//'#E8ECFB';
        RENDER.box(YOU.x-15,YOU.y-15,0,31,31,0);
    },
