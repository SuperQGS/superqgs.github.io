...
var CURSOR = {
    ...
    detectRadius: function (click) {
        ...
        for (i = TILES.array.length-1; i >= 0; i--) {
            ...
            if (RENDER.distance(click, point) < radius) { //distance is a bit more expensive than a square radius. It makes sense to do for a cool effect, but this is just logging tiles to check for.
        ...
        //get faces
        for (i = 0; i < CURSOR.withinRadius.length; i++) {
        ...
        TILES.sortByDistance(CURSOR.radiusTiles);
    },
